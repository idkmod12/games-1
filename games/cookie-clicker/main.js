...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarPatreon'),'<div style="padding:8px;width:250px;text-align:center;">Let us know of anything that is not working on this port.</div>','this');
